...
namespace nlohmann {
    ...
    inline void from_json(const json &j, API::UserIdType &x) {
        if (j == "Anonymous")
            x = API::UserIdType::ANONYMOUS;
        else if (j == "User")
            x = API::UserIdType::USER;
        else
    ...
    inline void to_json(json &j, const API::UserIdType &x) {
        switch (x) {
        case API::UserIdType::ANONYMOUS:
            j = "Anonymous";
            break;
        case API::UserIdType::USER:
            j = "User";
            break;
        default:
    ...
    inline void from_json(const json &j, API::AchievementProgressType &x) {
        if (j == "achievement_progress")
            x = API::AchievementProgressType::ACHIEVEMENT_PROGRESS;
        else
            throw "Input JSON does not conform to schema";
    }
    ...
    inline void to_json(json &j, const API::AchievementProgressType &x) {
        switch (x) {
        case API::AchievementProgressType::ACHIEVEMENT_PROGRESS:
            j = "achievement_progress";
            break;
        default:
            throw "This should not happen";
        }
    ...
    inline void from_json(const json &j, API::AchievementUnlockType &x) {
        if (j == "achievement_unlock")
            x = API::AchievementUnlockType::ACHIEVEMENT_UNLOCK;
        else
            throw "Input JSON does not conform to schema";
    }
    ...
    inline void to_json(json &j, const API::AchievementUnlockType &x) {
        switch (x) {
        case API::AchievementUnlockType::ACHIEVEMENT_UNLOCK:
            j = "achievement_unlock";
            break;
        default:
            throw "This should not happen";
        }
    ...
    inline void to_json(json &j, const API::RedirectType &x) {
        switch (x) {
        case API::RedirectType::REDIRECT:
            j = "redirect";
            break;
        default:
            throw "This should not happen";
    ...
    inline void from_json(const json &j, API::GameStateType &x) {
        if (j == "game_state")
            x = API::GameStateType::GAME_STATE;
        else
            throw "Input JSON does not conform to schema";
    }
    ...
    inline void to_json(json &j, const API::GameStateType &x) {
        switch (x) {
        case API::GameStateType::GAME_STATE:
            j = "game_state";
            break;
        default:
            throw "This should not happen";
    ...
    inline void to_json(json &j, const API::WelcomeMsgType &x) {
        switch (x) {
        case API::WelcomeMsgType::WELCOME:
            j = "welcome";
            break;
        default:
            throw "This should not happen";
    ...
    inline void to_json(json &j, const API::RestartMsgType &x) {
        switch (x) {
        case API::RestartMsgType::RESTART:
            j = "restart";
            break;
        default:
            throw "This should not happen";
    ...
    inline void from_json(const json &j, API::RollAgainMsgType &x) {
        if (j == "roll_again")
            x = API::RollAgainMsgType::ROLL_AGAIN;
        else
            throw "Input JSON does not conform to schema";
    }
    ...
    inline void to_json(json &j, const API::RollAgainMsgType &x) {
        switch (x) {
        case API::RollAgainMsgType::ROLL_AGAIN:
            j = "roll_again";
            break;
        default:
            throw "This should not happen";
    ...
    inline void from_json(const json &j, API::DisconnectMsgType &x) {
        if (j == "disconnect")
            x = API::DisconnectMsgType::DISCONNECT;
        else
            throw "Input JSON does not conform to schema";
    }
    ...
    inline void to_json(json &j, const API::DisconnectMsgType &x) {
        switch (x) {
        case API::DisconnectMsgType::DISCONNECT:
            j = "disconnect";
            break;
        default:
            throw "This should not happen";
    ...
    inline void from_json(const json &j, API::ReconnectMsgType &x) {
        if (j == "reconnect")
            x = API::ReconnectMsgType::RECONNECT;
        else
            throw "Input JSON does not conform to schema";
    }
    ...
    inline void to_json(json &j, const API::ReconnectMsgType &x) {
        switch (x) {
        case API::ReconnectMsgType::RECONNECT:
            j = "reconnect";
            break;
        default:
            throw "This should not happen";
    ...
    inline void from_json(const json &j, API::UpdateTurnMsgType &x) {
        if (j == "update_turn")
            x = API::UpdateTurnMsgType::UPDATE_TURN;
        else
            throw "Input JSON does not conform to schema";
    }
    ...
    inline void to_json(json &j, const API::UpdateTurnMsgType &x) {
        switch (x) {
        case API::UpdateTurnMsgType::UPDATE_TURN:
            j = "update_turn";
            break;
        default:
            throw "This should not happen";
    ...
    inline void from_json(const json &j, API::UpdateNameMsgType &x) {
        if (j == "update_name")
            x = API::UpdateNameMsgType::UPDATE_NAME;
        else
            throw "Input JSON does not conform to schema";
    }
    ...
    inline void to_json(json &j, const API::UpdateNameMsgType &x) {
        switch (x) {
        case API::UpdateNameMsgType::UPDATE_NAME:
            j = "update_name";
            break;
        default:
            throw "This should not happen";
