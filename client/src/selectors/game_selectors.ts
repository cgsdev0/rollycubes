...
export const selectSelfScore = createSelector(selectSelf, self => self.score);
...
export const selectOtherPlayerScores = createSelector(selectPlayers, (players) => players.map(p => p.score))

export const selectHasMultiplePlayers = createSelector(selectPlayers, players => Boolean(players.length > 1))

export const selectWinner = createSelector(selectPlayers, selectIsGameOver, selectTurnIndex, (players, victory, turn) => {
