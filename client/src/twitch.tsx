...
const TwitchIcon = () => {
return (<svg width="64px" height="64px" viewBox="0 0 256 268" version="1.1" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" className={(weird())}>
    <g>
...
const UnconnectedTwitchButton: React.FC<{ intent: string; authService: string }> = ({
intent,
  authService,
}) => {
  return (
  <>
    <button onClick={twitchLogin(authService, intent)} className={twitchButton()}>
      Login With Twitch
  <TwitchIcon />
    </button>
    </>
